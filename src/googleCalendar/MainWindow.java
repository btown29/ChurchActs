...
public class MainWindow extends BaseWindow
{
	...
	{
		setSize(706, 497);
		setTitle("Reuniones en Iglesia1");
		setInfo("Falta por implementar -------------------  Se mostrará en pantalla las reuniones que se agendarán primero. A partir"
				+ "del algoritmo Greedy");
		setVisible(true);
